...
export OVIRT40="/var/www/html/pub/ovirt-4.0-snapshot/rpm/el7/noarch"
...
ln -sf `ls "${OVIRT41}"/ovirt-release41-experimental-4* |tail -n 1` "${YUMREPO}/ovirt-release41-experimental.rpm"
ln -sf `ls "${OVIRT40}"/ovirt-release40-snapshot-4* |tail -n 1` "${YUMREPO}/ovirt-release40-snapshot.rpm"
